...
## Writing Constants for global usage
- to avoid constant typos and hard coding values
- the variables are declared in the utils directory and now can be accessed from anywhere
```javascript
